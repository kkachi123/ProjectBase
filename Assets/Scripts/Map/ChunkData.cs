...
public class ChunkData : MonoBehaviour
{
    ...
    [SerializeField] private Vector2Int entrance2 = new Vector2Int(18, 3);
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            Gizmos.DrawCube(this.transform.position + new Vector3(arrowTrap.x + 0.5f, arrowTrap.y + 0.5f), Vector3.one);
        }
