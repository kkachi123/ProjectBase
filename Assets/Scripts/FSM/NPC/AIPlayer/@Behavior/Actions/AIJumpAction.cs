...
[NodeDescription(name: "AIJumpAction", story: "[Input] Jump [JumpFloor]", category: "Action", id: "b7b03e72f3028b868b5a3bd7e07b30e1")]
public partial class AIJumpAction : Action
{
    ...
    // Use Abort Before this Action
    // Check Target is not null 
    protected override Status OnStart()
    {
        if(JumpFloor.Value == null) return Status.Failure;
